        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              <TabsList className="grid w-full grid-cols-2">
                ...
                <TabsTrigger value="critiques" className="flex items-center gap-2">
                  🎥 My Critiques
                </TabsTrigger>
              </TabsList>
          ...
          <div className="space-y-6">
            <div className="rounded-lg border bg-card text-card-foreground shadow p-6">
              ...
              <p className="text-muted-foreground mb-4">Upload a new dance video for critique</p>
            ...
            <div className="rounded-lg border bg-card text-card-foreground shadow p-6">
              <h2 className="text-xl font-semibold mb-4">Find an Adjudicator</h2>
              <p className="text-muted-foreground mb-4">Browse our professional adjudicators</p>
            ...
            <div className="rounded-lg border bg-card text-card-foreground shadow p-6">
              ...
              <p className="text-muted-foreground mb-4">Manage your profile and billing</p>
