...
import EnhancedVideoUploadForm from '@/components/critique/EnhancedVideoUploadForm';
...
const UploadVideo: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const selectedAdjudicatorId = sessionStorage.getItem('selectedAdjudicatorId');
    const selectedAdjudicatorName = sessionStorage.getItem('selectedAdjudicatorName');
  ...
  return (
    <AppLayout>
      <div className="container mx-auto py-8 px-4">
        ...
        <EnhancedVideoUploadForm onUploadSuccess={handleUploadSuccess} />
      </div>
    </AppLayout>
  );
};
