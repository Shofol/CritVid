...
const AdjudicatorProfileModalUpdated: React.FC<AdjudicatorProfileModalProps> = ({
  adjudicator,
  isOpen,
  onClose,
  onSelect,
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-muted-foreground mb-3">{adjudicator.credentials}</p>
              ...
              <TabsContent value="profile" className="space-y-6">
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div className="text-center p-4 bg-muted rounded-lg">
                    ...
                    <div className="text-xs text-muted-foreground">Per Critique</div>
                  </div>
                  <div className="text-center p-4 bg-muted rounded-lg">
...
export default AdjudicatorProfileModalUpdated;