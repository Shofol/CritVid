...
const FullExaminerAgreement: React.FC<FullExaminerAgreementProps> = ({ onAccept, onCancel }) => {
  ...
  return (
    <div className="space-y-6 p-4 max-w-4xl mx-auto bg-white rounded-lg shadow-lg text-gray-900">
      <h2 className="text-2xl font-bold text-center text-gray-900">VidCrit Examiner Agreement</h2>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="part2" className="mt-0">
          ...
          <div className="flex justify-between mt-4 pb-4">
            <Button variant="outline" onClick={() => setActiveTab('part1')}>Previous</Button>
        ...
        <TabsContent value="part3" className="mt-0">
          ...
          <div className="flex justify-between mt-4 pb-4">
            <Button variant="outline" onClick={() => setActiveTab('part2')}>Previous</Button>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 border-t pt-4">
        ...
        <div className="flex items-center space-x-2">
          ...
          <Label htmlFor="agreement" className="text-sm text-gray-800">
            I have read and agree to the VidCrit Examiner Agreement. I understand that checking this box constitutes a legal signature.
          </Label>
        </div>
        
        <div className="flex justify-end space-x-4 pt-2">
          <Button type="button" variant="outline" onClick={onCancel}>Cancel</Button>
          <Button type="submit" disabled={!agreed || !fullName}>Accept Agreement</Button>
        </div>
      </form>
    </div>
  );
