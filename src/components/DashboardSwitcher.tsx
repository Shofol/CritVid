...
//     role: "client" | "admin" | "adjudicator" | "studio_critique"
//   ) => {
//     setUserRole(role);
...
//               View your uploaded videos, find adjudicators, and track your
//               progress.
//             </p>
//             <Button
//               className="w-full"
...
//         <p>
//           Note: In a production environment, users would only have access to
